/**
 * Solution — K-12 Single Campus
 * Specialized solution page for single-campus K-12 schools
 * 
 * Sections:
 * 1️⃣ Hero Section (localized image + headline)
 * 2️⃣ Problem Section (challenges for single-campus K-12)
...
export function SolutionK12() {
  ...
  const setupTime = useCounter(3, 2000, metricsVisible);
  const complianceRate = useCounter(100, 2000, metricsVisible);
  const responseImprovement = useCounter(85, 2000, metricsVisible);
  const timeSaved = useCounter(15, 2000, metricsVisible);
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                justifyContent: 'center',
                position: 'relative',
                boxShadow: '0 8px 24px 0 rgba(43, 94, 156, 0.15)'
              }}>
                <GraduationCap style={{ 
                  width: '160px', 
                  height: '160px', 
            ...
            <div style={{ width: '55%' }}>
              ...
              <p style={{
                ...
                Everything you need to protect students, staff, and visitors — all in one unified platform designed for single-campus K-12 schools.
              </p>
        ...
        <section className="solution-section fade-up-on-scroll delay-100" style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Single-campus schools face unique safety challenges that require comprehensive, easy-to-manage solutions.
            </p>
            ...
            <div className="problem-grid" style={{
              ...
              {[
                {
                  icon: <AlertTriangle style={{ width: '32px', height: '32px', color: 'var(--qs-brand-accent)' }} />,
                  title: "Manual Processes",
                  description: "Paper-based visitor logs, manual drill tracking, and disconnected communication systems waste valuable time."
                },
                {
                  icon: <FileText style={{ width: '32px', height: '32px', color: 'var(--qs-brand-accent)' }} />,
                  title: "Compliance Burden",
                  description: "Meeting state drill requirements and generating audit-ready documentation is time-consuming and error-prone."
                },
                {
                  icon: <Clock style={{ width: '32px', height: '32px', color: 'var(--qs-brand-accent)' }} />,
                  title: "Slow Response Times",
                  description: "Fragmented systems delay emergency response and make it difficult to coordinate staff during critical incidents."
                }
              ].map((problem, idx) => (
                <div
                  key={idx}
        ...
        <section className="solution-section fade-up-on-scroll delay-200" style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              A unified platform that automates safety workflows, ensures compliance, and accelerates emergency response.
            </p>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <Lock style={{ width: '120px', height: '120px', color: 'var(--qs-brand-accent)', opacity: 0.6 }} />
                </div>
                <div style={{ width: '50%' }}>
                  <div style={{
                  ...
                  <p style={{
                    ...
                    Digital check-in kiosks with automated background checks, photo ID capture, and instant badge printing. Track all visitors in real-time from a single dashboard.
                  </p>
                  <ul style={{
                    listStyle: 'none',
                    padding: 0,
                    ...
                    {[
                      ...
                      <li key={idx} style={{
                        ...
                        <CheckCircle style={{ width: '20px', height: '20px', color: 'var(--qs-brand-accent)' }} />
                        {item}
                      </li>
                    ))}
                  </ul>
              ...
              <div style={{
                ...
                <div style={{ width: '50%' }}>
                  ...
                  <p style={{
                    ...
                    Send instant alerts to staff, students, and first responders with a single tap. Multi-channel notifications ensure everyone receives critical information immediately.
                  </p>
                  <ul style={{
                    listStyle: 'none',
                    padding: 0,
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <Activity style={{ width: '120px', height: '120px', color: 'var(--qs-brand-accent)', opacity: 0.6 }} />
                </div>
                <div style={{ width: '50%' }}>
                  <div style={{
                    display: 'inline-block',
                  ...
                  <p style={{
                    ...
                    Schedule, execute, and document all required safety drills automatically. Generate state-compliant reports with one click.
                  </p>
                  <ul style={{
                    listStyle: 'none',
                    padding: 0,
                    ...
                    {[
                      ...
                      'Digital documentation and sign-offs',
        ...
        >
          <div style={{
            ...
            <p style={{
              ...
              Real outcomes from K-12 schools using QuickSecure
            </p>
            ...
            <div className="metrics-grid" style={{
              ...
              <div className="hover-lift" style={{
                ...
                <div style={{
                  ...
                  {setupTime} <span style={{ fontSize: '32px' }}>days</span>
                </div>
                <div style={{
                  fontFamily: 'Inter, sans-serif',
                  fontSize: '16px',
              ...
              <div className="hover-lift" style={{
                ...
                <div style={{
                  ...
                  {timeSaved} <span style={{ fontSize: '32px' }}>hrs</span>
                </div>
                <div style={{
                  fontFamily: 'Inter, sans-serif',
                  fontSize: '16px',
        ...
        <section className="fade-up-on-scroll delay-400" style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Get started with QuickSecure to protect your students and staff.
            </p>
