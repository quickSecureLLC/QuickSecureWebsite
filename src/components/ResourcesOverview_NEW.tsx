...
function GrantsTab({ onOpenViewer }: { onOpenViewer: (title: string, content: React.ReactNode) => void }) {
  const grants = [
    {
      icon: <DollarSign style={{ width: '28px', height: '28px' }} />,
      title: "Federal School Safety Grants",
      summary: "Access federal funding opportunities for school safety infrastructure and technology upgrades.",
      content: <div style={{ padding: '24px' }}>
        <h3 style={{ marginBottom: '16px', color: '#1E1E1E' }}>Federal School Safety Grants</h3>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Access comprehensive information about federal grant programs designed to enhance school safety infrastructure and emergency preparedness.
        </p>
        <h4 style={{ marginTop: '24px', marginBottom: '12px', color: 'var(--qs-brand-accent)' }}>Eligibility Requirements</h4>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Learn about eligibility criteria for K-12 schools, including public, private, and charter institutions.
        </p>
        <h4 style={{ marginTop: '24px', marginBottom: '12px', color: 'var(--qs-brand-accent)' }}>Application Process</h4>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Step-by-step guide to preparing and submitting grant applications for school safety technology upgrades.
        </p>
      </div>
    },
    {
      icon: <Building style={{ width: '28px', height: '28px' }} />,
      title: "State Safety Grants",
      summary: "State-level funding opportunities for school safety improvements and technology implementation.",
      content: <div style={{ padding: '24px' }}>
        <h3 style={{ marginBottom: '16px', color: '#1E1E1E' }}>State Safety Grant Programs</h3>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Explore state-specific grant opportunities for school safety infrastructure and emergency response systems.
        </p>
        <h4 style={{ marginTop: '24px', marginBottom: '12px', color: 'var(--qs-brand-accent)' }}>State-by-State Resources</h4>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Access state-specific grant information, deadlines, and application requirements.
        </p>
      </div>
    },
    {
      ...
      summary: "Private foundation funding for educational safety initiatives and technology upgrades.",
      content: <div style={{ padding: '24px' }}>
        <h3 style={{ marginBottom: '16px', color: '#1E1E1E' }}>Foundation Grant Opportunities</h3>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Discover private foundation grants focused on school safety, emergency preparedness, and student wellbeing.
        </p>
      </div>
    },
    {
      icon: <Download style={{ width: '28px', height: '28px' }} />,
      title: "Grant Writing Resources",
      summary: "Templates, guides, and best practices for successful grant applications.",
      content: <div style={{ padding: '24px' }}>
        <h3 style={{ marginBottom: '16px', color: '#1E1E1E' }}>Grant Writing Resources</h3>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Access professional grant writing templates and guidance to maximize your funding success.
        </p>
      </div>
    },
    {
      ...
      summary: "Funding specifically for safety equipment, surveillance systems, and emergency tools.",
      content: <div style={{ padding: '24px' }}>
        <h3 style={{ marginBottom: '16px', color: '#1E1E1E' }}>Safety Equipment Grants</h3>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Learn about grants dedicated to purchasing safety equipment and emergency response technology.
        </p>
      </div>
    },
    {
      ...
      summary: "Real examples of schools that successfully secured funding for safety improvements.",
      content: <div style={{ padding: '24px' }}>
        <h3 style={{ marginBottom: '16px', color: '#1E1E1E' }}>Grant Success Stories</h3>
        <p style={{ marginBottom: '16px', lineHeight: 1.6, color: '#4A4A4A' }}>
          Read case studies of schools that successfully obtained grant funding for QuickSecure implementation.
        </p>
      </div>
    }
  ];
